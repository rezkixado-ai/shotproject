...
export const DEFAULT_CONTENT: SiteContent = {
  ...
  section04: {
    ...
    titleHighlight: 'JAGO.',
    items: [
      { id: 'i1', icon: 'smile', text: 'Kalau lo belum pernah acting, nggak masalah.' },
  ...
  section05: {
    ...
    items: [
      { id: 'd1', icon: 'award', title: 'Membawa pengalaman', description: 'Lo mungkin akan pulang bukan cuma membawa footage. Tapi membawa pengalaman.' },
      { id: 'd2', icon: 'book-open', title: 'Ketemu orang baru', description: 'Punya cerita baru. Punya sesuatu yang pernah lo buat.' },
      { id: 'd3', icon: 'users', title: 'Teman baru', description: 'Dan mungkin... punya teman baru yang sama-sama suka bikin sesuatu.' },
      { id: 'd4', icon: 'heart', title: 'Kenangan bareng', description: 'Momen-momen kecil di proses shooting yang bakal jadi kenangan.' },
    ],
  ...
  section06: {
    ...
    offers: [
      { id: 'o1', icon: 'zap', label: 'ruang untuk mencoba' },
      { id: 'o2', icon: 'book-open', label: 'ruang untuk belajar' },
      { id: 'o3', icon: 'users', label: 'ruang untuk berkarya' },
      { id: 'o4', icon: 'handshake', label: 'kesempatan untuk membuat sesuatu bersama' },
    ],
